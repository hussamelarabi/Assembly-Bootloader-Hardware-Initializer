...
start_location   dq  0xA0  ; A default start position (Line # 8)

    
    hello_world_str db 'Hello all here',13, 0
    page_mapped_str db 'Page Table Mapped',13,0
    test_string db 'testing',13,0
    test_string1 db 'testing1',0
    test_string2 dq 'test1', 0
