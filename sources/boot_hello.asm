...
;**************************** Padding and Signature **********************************
      ...
      db 0x00, 0x01, 0x00     ;Starting CHS of (0,0,1)
      db 0x83                 ;FAT32 format
      db 0x80, 10111111b, 0x00     ;Ending CHS
      dd 0x01           ;0xF007FE is hexadecimal representation of 15730686 which is the max number of sectors my specific usb hold minus 2 (minus 1 since index starts at zero and minus one to account for the MBR)
      dd  0xF4200
